...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> VANITY_ARMOR_MATERIAL = register("vanity",
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
        ...
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, name);
