...
public class Constants {
    ...
    public static final int PLAYER_EQ_TOTAL_SLOT_COUNT = PLAYER_HOTBAR_SLOT_COUNT + PLAYER_EQ_SLOT_COUNT;
    public static final int PLAYER_EQ_FIRST_SLOT_INDEX = 0;

    public static final int SEWING_STATION_FIRST_SLOT_INDEX = PLAYER_EQ_TOTAL_SLOT_COUNT + PLAYER_EQ_FIRST_SLOT_INDEX;
    public static final int SEWING_STATION_SLOT_COUNT = 30;
