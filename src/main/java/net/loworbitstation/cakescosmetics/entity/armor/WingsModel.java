...
public class WingsModel extends GeoModel<WingsItem> {
    ...
    public ResourceLocation getModelResource(WingsItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "geo/wings.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(WingsItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "textures/models/armor/wings.png");
    }
