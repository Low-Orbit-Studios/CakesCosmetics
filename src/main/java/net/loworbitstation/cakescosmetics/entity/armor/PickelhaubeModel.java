...
public class PickelhaubeModel extends GeoModel<PickelhaubeItem> {
    ...
    public ResourceLocation getModelResource(PickelhaubeItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "geo/pickelhaube.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(PickelhaubeItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "textures/models/armor/pickelhaube.png");
    }
