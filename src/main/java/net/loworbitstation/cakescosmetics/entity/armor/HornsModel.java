...
public class HornsModel extends GeoModel<HornsItem> {
    ...
    public ResourceLocation getModelResource(HornsItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "geo/horns.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(HornsItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "textures/models/armor/horns.png");
    }
