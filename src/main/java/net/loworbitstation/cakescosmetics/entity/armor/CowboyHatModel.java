...
public class CowboyHatModel extends GeoModel<CowboyHatItem> {
    ...
    public ResourceLocation getModelResource(CowboyHatItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "geo/cowboy_hat.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(CowboyHatItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "textures/models/armor/cowboy_hat.png");
    }
