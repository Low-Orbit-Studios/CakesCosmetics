...
public class SheathedKatanaModel extends GeoModel<SheathedKatanaItem> {
    ...
    public ResourceLocation getModelResource(SheathedKatanaItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "geo/sheathed_katana.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(SheathedKatanaItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "textures/models/armor/sheathed_katana.png");
    }
