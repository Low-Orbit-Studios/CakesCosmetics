...
public class BandolierModel extends GeoModel<BandolierItem> {
    ...
    public ResourceLocation getModelResource(BandolierItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "geo/bandolier.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(BandolierItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "textures/models/armor/bandolier.png");
    }
