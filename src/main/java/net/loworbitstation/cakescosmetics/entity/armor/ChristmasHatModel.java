...
public class ChristmasHatModel extends GeoModel<ChristmasHatItem> {
    ...
    public ResourceLocation getModelResource(ChristmasHatItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "geo/christmas_hat.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ChristmasHatItem object) {
        return ResourceLocation.fromNamespaceAndPath(CakesCosmetics.MOD_ID, "textures/models/armor/christmas_hat.png");
    }
